#I have added this section because it can be used to give a nice overview of what the
#script does and you can use it as a way to show that you know how to code when you
#are applying for a job or any academic program
#You can delete this is you do not like it, or do not plan to share it.
